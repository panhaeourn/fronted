...
const translations = {
  en: {
    ...
    "app.admin": "ADMIN",
    "app.certificates": "CITO Certificate",
    ...
    "settings.telegramValue": "Message on Telegram",
  ...
  km: {
    ...
    "app.certificates": "វិញ្ញាបនបត្រ CITO",
    ...
    "settings.telegramValue": "ផ្ញើសារតាម Telegram",
